...
public class movieReviewService {
	...
	public static void add_Movie(String movie_text)
	{
		...
		{
			genres = movie_text.split("Genres ")[1].replace("“", "").replace("”", "");
		}
		else
		{
			genres = movie_text.split("Genre ")[1].replace("“", "").replace("”", "");
		}
	...
	{
		movieReviewService.add_Movie("\"Don\" released in Year 2006 for Genres “Action” & “Comedy”");
		movieReviewService.add_Movie("\"Tiger\" released in Year 2008 for Genre “Drama”");
		movieReviewService.add_Movie("\"Padmaavat\" released in Year 2006 for Genre “Comedy”");
		movieReviewService.add_Movie("\"Lunchbox\" released in Year 2022 for Genre “Drama”");
		movieReviewService.add_Movie("\"Guru\" released in Year 2006 for Genre “Drama”");
		movieReviewService.add_Movie("\"Metro\" released in Year 2006 for Genre “Romance”");
	}
